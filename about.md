...
![Portrait of Amanda Weller on Ferris Wheel in Brussels Belgium](docs/Photo.png)
...
- **Clinical Rotations** (Jan 2024-- Present) *Brigham Young University Nursing Program*
    - Performed and documented patient vitals and assessments in the EMR across multiple clinical units, assisted with basic nursing care, and upheld patient safety and infection control standards.
- **Volunteer Technician** (Sep 2021 -- Apr 2022) *Primary Children's Hospital*
    - Facilitated surgical check-ins for families, supervised pediatric care in a safe environment, and assisted Child Life Specialists to support patient-centered care.
- **Math Tutor** (Jul 2020 -- Jul 2021) *Peninsula College Tutoring Center*
    - Provided individualized math support to students and led focused group sessions to strengthen understanding of key mathematical concepts.
- **Sterilization Technician** (Jun 2019 -- Feb 2020) *Advanta Dental*
    - Sterilized dental instruments, maintained supply inventory, and upheld sanitation protocols to ensure a safe and efficient clinical environment.
